  ...
  return (
    <div className="w-full mt-20 flex flex-col items-center justify-center">
      ...
      <div className="input mb-30">
        ...
        <button className="bg-coral-red hover:bg-coral-red text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline w-full" type="submit" onClick={submit}>Submit</button>
      </form>
      </div>
    // </div>
  );
